module.exports = {
  ...
  examples: ['clear 50', 'clear 50 @Totorock'],
  description: "Supprimer un nombre de messages spécifié sur un salon ou un utilisateur",
  ...
  options: [
    ...
    {
      name: "target",
      description: "Sélectionner l'utilistateur pour la suppression de messages",
      type: "USER",
      required: false
    }
  ],
